...
class ResponseStatusEnums(Enum):
    ...
    FILE_CHUNKS_NOT_FOUND = "No chunks found for this document"
    FILE_NOT_FOUND = "No file exists with this name"
    FILE_DELETED_SUCCESFULLY = "File deleted succesfully"

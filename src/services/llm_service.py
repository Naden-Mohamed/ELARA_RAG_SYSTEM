...
class LLMService:
    ...
    def build_system_prompt(
        self, persona: UserPersonaEnum, language: LanguageEnum
    ) -> str:
    ...
    def build_user_prompt(
        self, query: str, chunks: list[MockChunkInput], language: LanguageEnum
    ) -> str:
    ...
    async def generate_chat_response(
        ...
        system_prompt = self.build_system_prompt_with_memory(
            persona, language, mother_profile, dynamic_memories
        )
        user_prompt = self.build_user_prompt(query, chunks, language)
